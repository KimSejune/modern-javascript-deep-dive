...
// ES6 Class
class Foo {
  #private = 10; // stage 3 : 클래스 private field
...
console.log([(0,_lib_js__WEBPACK_IMPORTED_MODULE_0__.power)(_lib_js__WEBPACK_IMPORTED_MODULE_0__.pi, _lib_js__WEBPACK_IMPORTED_MODULE_0__.pi)]);

const f = new _lib_js__WEBPACK_IMPORTED_MODULE_0__.Foo();
console.log(f.foo());
console.log(f.bar());


// babel-polyfill이 필요한 코드
